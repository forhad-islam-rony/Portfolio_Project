...
<head>
    ...
    <body class="account-pages">
        ...
        <!-- Begin page -->
        <div class="accountbg" style="background: url('security.png');background-size: cover;background-position: center;"></div>
                              ...
                              <?php } ?>
                                ...
                                <div class="form-group row m-b-20">
                                    <div class="col-12">
                                        ...
                                        <input class="form-control" type="text" id="username" placeholder="Forhad Islam" name="fname" value="<?php
                                        if(isset($fname)){
                                          echo $fname;
                                        }
                                        ?>">
                                ...
                                <div class="form-group row m-b-20">
                                    <div class="col-12">
                                        ...
                                        <input class="form-control" type="text" id="emailaddress"  placeholder="forhadrony@gmail.com" name="email" value="<?php 
                                        if(isset($email)){
                                          echo $email;
                                        }
                                        ?>">
