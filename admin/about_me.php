...
$data_from_db = $dbcon->query("SELECT * FROM user");
																	  ...
																	  <div class="card-body">
																	  	<form action="about_me_update.php" method="post">
																				...
																				<div class="form-group">
																					...
																					<input type="text" class="form-control" name="fb_link" value="<?=$about_me_data['facebook']?>">
																				</div>

																				<div class="form-group">
																					<label for="project_catagory">Twitter Link</label>
																					<input type="text" class="form-control" name="twitter_link" value="<?=$about_me_data['instagram']?>">
																				</div>


																				<div class="form-group">
																					<label for="project_catagory">LinkedIn Link</label>
																					<input type="text" class="form-control" name="instra_link" value="<?=$about_me_data['linkediin']?>">
																				</div>

																				<div class="form-group">
																					<label for="project_catagory">Github link</label>
																					<input type="text" class="form-control" name="github_link" value="<?=$about_me_data['github']?>">
																				</div>
