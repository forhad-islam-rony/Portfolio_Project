...
<head>
    ...
    <body class="account-pages">
        ...
        <!-- Begin page -->
        <div class="accountbg" style="background: url('image/profile/admin_pic1.jpg');background-size: cover;background-position: center;"></div>
        ...
        <div class="wrapper-page account-page-full">
            ...
            <div class="m-t-40 text-center">
                <p class="account-copyright">2018 © Rony. -forhadrony161@gmail.com</p>
            </div>
