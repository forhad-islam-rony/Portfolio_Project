...
<head>
    ...
    <body class="account-pages">
        ...
        <div class="accountbg" style="background: url('admin_pic1.jpg');background-size: cover;background-position: center;"></div>
        ...
        <div class="wrapper-page account-page-full">
            ...
            <div class="m-t-40 text-center">
                <p class="account-copyright"><?=date('Y')?> © Forhad Islam Rony</p>
            </div>
